...
function toList(ingredient) {
  ...
  btnDelete.classList.add("btnListDelete");
  btnDelete.addEventListener("click", function (e) {
    e.currentTarget.parentNode.remove();
    var activeIng = e.currentTarget.parentNode.childNodes[0].nodeValue;
    var tempArray = JSON.parse(localStorage.getItem("ingredientArray"));
