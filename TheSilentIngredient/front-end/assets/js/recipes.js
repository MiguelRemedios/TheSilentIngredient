      ...
      function recipeamount(){
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("t11").innerHTML = `${res1.calories}`;
            document.getElementById("t31").innerHTML = `${res2.calories} ml`;
            document.getElementById("t51").innerHTML = `${res3.calories}`;
